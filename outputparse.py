...
if __name__ == '__main__':
	import argparse
	optparser = argparse.ArgumentParser(description='a program that takes a bunch of folders containing .accuracy files as input (which are of course generated by running model.py), sorts them and displays them')
	optparser.add_argument('paths', nargs='+', help="the path to the accuracy file(s)")
	...
	print(parser.get_folders_table(args.paths))
